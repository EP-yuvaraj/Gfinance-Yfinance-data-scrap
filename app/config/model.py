...
class TickersCurrentData(Base):
    ...
    current_open_price=Column(DOUBLE_PRECISION)
    current_high_price=Column(DOUBLE_PRECISION)
    current_low_price=Column(DOUBLE_PRECISION)
    current_volume_price=Column(DOUBLE_PRECISION)
    current_change=Column(DOUBLE_PRECISION)
    current_change_percentage=Column(DOUBLE_PRECISION)
    last_trade_date_time=Column(DateTime)
    yahoo_recommendation=Column(String(100))
...
class TickersHistoricalData(Base):
    ...
    historical_price_date_time=Column(DateTime)
